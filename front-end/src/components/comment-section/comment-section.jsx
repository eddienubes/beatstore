...
function CommentSection({ comments, userId, isLoggedIn }) {
  return (
    <div className="comment-section__wrapper">
      ...
      <section className="stat-wrapper">
        <span>
          {comments.reduce((accumulator, c) => c.likesCount + accumulator, 0)} LIKES{' '}
          <span className="like">
            <FontAwesomeIcon icon={faHeart} />
          </span>
        </span>
        <span>
          {comments.length} COMMENTS <FontAwesomeIcon icon={faCommentDots} />
        </span>
      </section>
