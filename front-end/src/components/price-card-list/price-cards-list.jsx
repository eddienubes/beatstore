    ...
    <>
      ...
      <CardDeck className="card-container">
        <Card className="card popular-card">
          <div className="head">
            <p>POPULAR</p>
            <div className="license-type">{licenses[2].label}</div>
            <div className="price">${licenses[2].price}</div>
            <div className="per-unit">PER UNIT</div>
          </div>
          ...
          <div className="card-footer card-footer-white">
            <div className="card-footer-caption">
              <span>
                <FontAwesomeIcon className="icon" icon={faTag} /> FREE BEATS
              </span>
            ...
            <Accordion activeKey={activeKey} onSelect={(e) => setActiveKey(e)}>
              <Accordion.Collapse className="card-footer-content" eventKey="0">
                <div>
                  ...
                  <p>BUY 4, GET 3 FREE</p>
                  <p>BUY 5, GET 4 FREE</p>
                  <p>BUY 6, GET 5 FREE</p>
        ...
        <Card className="card">
          <div className="head">
            <div className="license-type">{licenses[3].label}</div>
            <div className="price">${licenses[3].price}</div>
            <div className="per-unit">PER UNIT</div>
          </div>
          <div className="description">
            <ul>
        ...
        <Card className="card">
          <div className="head">
            <div className="license-type">{licenses[1].label}</div>
            <div className="price">${licenses[1].price}</div>
            <div className="per-unit">PER UNIT</div>
          </div>
          <div className="description">
            <ul>
        ...
        <Card className="card">
          <div className="head">
            <div className="license-type">{licenses[0].label}</div>
            <div className="price">${licenses[0].price}</div>
            <div className="per-unit">PER UNIT</div>
          </div>
          <div className="description">
            <ul>
