...
function LicenseDescriptionModal(props) {
  ...
  return (
    <Modal className="modal-pop" {...props} size="lg" centered scrollable>
      ...
      <Modal.Footer>
        <Button className="license-close-button" onClick={props.onHide}>
          Close
        </Button>
      </Modal.Footer>
    </Modal>
