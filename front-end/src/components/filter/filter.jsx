...
export default function Filter() {
  ...
  const [bpms, moods, genres, tags] = useMemo(
    () => [
      ...
      [
        { key: 'all2', text: 'All moods' },
        ...info.moods.map((b, index) => ({
          key: b + index,
          value: b,
          text: b
        }))
      ...
      [
        { key: 'all3', text: 'All genres' },
        ...info.genres.map((b, index) => ({
          key: b + index,
          value: b,
          text: b
        }))
      ...
      [
        { key: 'all4', text: 'All tags' },
        ...info.tags.map((b, index) => ({
          key: b + index,
          value: b,
          text: b
        }))
