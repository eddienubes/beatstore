...
function PurchaseSuccessful() {
  ...
  useEffect(() => () => dispatch(paymentAcceptanceDrop()));
  ...
  return (
    <div className="payment-successful-container">
      ...
      <br />
      <br />
      <p className="description">Please, checkout your email to download files you have payed for!</p>
      <p className="nutshell">
        In case you have any issues during purchasing process, consider <Link to="/contact">contacting</Link> via my social media
        or email.
      </p>
    </div>
  );
