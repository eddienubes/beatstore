...
bot.action([actionNames.EDIT_LICENSE_LABEL, actionNames.EDIT_LICENSE_PRICE], actions.editLicense);
...
bot.action(
  [actionNames.MOVE_ORDER_PRODUCTS_PREVIOUS_PAGE, actionNames.MOVE_ORDER_PRODUCTS_NEXT_PAGE],
...
bot.action([actionNames.MOVE_USERS_NEXT_PAGE, actionNames.MOVE_USERS_PREVIOUS_PAGE], actions.controlUserButtons);
...
bot.action([actionNames.MOVE_PURCHASES_NEXT_PAGE, actionNames.MOVE_PURCHASES_PREVIOUS_PAGE], actions.controlButtonsPurchases);
