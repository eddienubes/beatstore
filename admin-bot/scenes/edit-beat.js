...
const editTitleScene = new WizardScene(
  sceneNames.EDIT_BEAT_TITLE_SCENE,
  async (ctx) => {
...
const editBPMScene = new WizardScene(
  sceneNames.EDIT_BEAT_BPM_SCENE,
  async (ctx) => {
...
const editScaleScene = new WizardScene(
  sceneNames.EDIT_BEAT_SCALE_SCENE,
  async (ctx) => {
...
const editTagsScene = new WizardScene(
  sceneNames.EDIT_BEAT_TAGS_SCENE,
  async (ctx) => {
...
const editImageScene = new WizardScene(
  sceneNames.EDIT_BEAT_IMG_URL_SCENE,
  async (ctx) => {
...
const editPreviewAudioScene = new WizardScene(
  sceneNames.EDIT_BEAT_PREVIEW_AUDIO_URL_SCENE,
  async (ctx) => {
...
const editMP3UrlScene = new WizardScene(
  sceneNames.EDIT_BEAT_MP3_URL_SCENE,
  async (ctx) => {
...
const editWavUrlScene = new WizardScene(
  sceneNames.EDIT_BEAT_WAV_URL_SCENE,
  async (ctx) => {
...
const editSTEMSUrlScene = new WizardScene(
  sceneNames.EDIT_BEAT_STEMS_URL_SCENE,
  async (ctx) => {
...
const editGenresScene = new WizardScene(
  sceneNames.EDIT_BEAT_GENRES_SCENE,
  async (ctx) => {
...
const editMoodsScene = new WizardScene(
  sceneNames.EDIT_BEAT_MOODS_SCENE,
  async (ctx) => {
